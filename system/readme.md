...
Připravil jsem insytalční skript [instalace-systemu.sh](system/instalace-systemu.sh). Je třeba ho nahrát na server a spustit jako root. Pokud se přihlašujete jako běžný uživatel a systémové příkazy spouštíte přes sudo, zvolí skript použítí sudo. 
