...
3. **Vytvoření kontejnerů***: podle předpisu použitelného v Portaineru: soubory [mongodb.yaml](docker/mongodb.yaml), ```nightscout.yaml```, ```traefik.yaml```. Postup je v README.mg ve složce docker.
